...
Scenario: navigate to create At-Risk form
  ...
  Then I should be on the new At-Risk form page
...
Scenario: navigate to create Autism form
  Given I am on the user dashboard page
  When I follow "New Autism Form"
  Then I should be on the new Autism form page
...
Scenario: create new atrisk form
  ...
  And I fill in "This person has Alzheimer's" with "F"
...
Scenario: create new autism form
  ...
  And I fill in "Individual's favorite toys" with "stuffed animals"
  And I upload picture with "pic.jpg"
  And I press "Submit Form"
